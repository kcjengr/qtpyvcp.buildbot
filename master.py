...
c['schedulers'].append(schedulers.SingleBranchScheduler(
    ...
    change_filter=util.ChangeFilter(category='tag', project='kcjengr/qtpyvcp', branch='master'),
    treeStableTimer=30,
...
c['schedulers'].append(schedulers.SingleBranchScheduler(
    ...
    change_filter=util.ChangeFilter(category='tag', project='kcjengr/probe_basic', branch='master'),
    treeStableTimer=30,
...
c['buildbotURL'] = "http://repository.qtpyvcp.com:8010/"
