...
# QtPyVCP Develop Factory arm64

import os

from buildbot.plugins import steps, util

factory_qtpyvcp_pyqt5_arm64_dev = util.BuildFactory()
...
factory_qtpyvcp_pyqt5_arm64_dev.addStep(
    steps.FileUpload(
        ...
        workersrc=util.Interpolate(
            "/home/bb/work/qtpyvcp-pyqt5-arm64-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb"
        ),
        masterdest=util.Interpolate(
            "/home/buildbot/repo/qtpyvcp-pyqt5-arm64-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb"
        ),
        mode=0o644,
    )
)
...
factory_qtpyvcp_pyqt5_arm64_dev.addStep(
    steps.FileUpload(
        ...
        masterdest=util.Interpolate(
            "/home/buildbot/debian/apt/pool/main/bookworm-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb"
        ),
    )
)
