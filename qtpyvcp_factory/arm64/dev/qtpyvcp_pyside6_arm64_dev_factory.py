...
factory_qtpyvcp_pyside6_arm64_dev.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/qtpyvcp-pyside6-arm64-dev/python3-qtpyvcp%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb"),
    masterdest=util.Interpolate("/home/buildbot/repo/qtpyvcp-pyside6-arm64-dev/python3-qtpyvcp%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb")))
