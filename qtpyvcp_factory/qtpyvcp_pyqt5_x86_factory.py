...
# download sources
factory_qtpyvcp_pyqt5_x86.addStep(
    steps.GitHub(
...
factory_qtpyvcp_pyqt5_x86.addStep(
    steps.FileUpload(
        ...
        workersrc=util.Interpolate(
            "/home/bb/work/qtpyvcp-pyqt5-x86/python3-qtpyvcp_%(prop:tag)s_amd64.deb"
        ),
        masterdest=util.Interpolate(
            "/home/buildbot/repo/qtpyvcp-pyqt5-x86/python3-qtpyvcp_%(prop:tag)s_amd64.deb"
        ),
        mode=0o644,
    )
)
...
factory_qtpyvcp_pyqt5_x86.addStep(
    steps.FileUpload(
        ...
        masterdest=util.Interpolate(
            "/home/buildbot/debian/apt/pool/main/bookworm/python3-qtpyvcp_%(prop:tag)s_amd64.deb"
        ),
    )
)
