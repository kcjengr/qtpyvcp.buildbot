...
# QtPyVCP Develop Factory x86 pyqt5
...
factory_qtpyvcp_pyqt5_x86_dev.addStep(
    steps.FileUpload(
        ...
        workersrc=util.Interpolate(
            "/home/bb/work/qtpyvcp-pyqt5-x86-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_amd64.deb"
        ),
        masterdest=util.Interpolate(
            "/home/buildbot/repo/qtpyvcp-pyqt5-x86-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_amd64.deb"
        ),
        mode=0o644,
    )
)
...
factory_qtpyvcp_pyqt5_x86_dev.addStep(
    steps.FileUpload(
        ...
        masterdest=util.Interpolate(
            "/home/buildbot/debian/apt/pool/main/bookworm-dev/python3-qtpyvcp_%(prop:tag)s-%(prop:minor_version)s.dev_amd64.deb"
        ),
    )
)
