...
# QtPyVCP Stable Factory pyside6 x86

import os

from buildbot.plugins import steps, util

factory_qtpyvcp_pyside6_x86 = util.BuildFactory()

# download sources
factory_qtpyvcp_pyside6_x86.addStep(steps.GitHub(name="download sources",
...
# get git tag
factory_qtpyvcp_pyside6_x86.addStep(steps.SetPropertyFromCommand(
    name="get git tag",
