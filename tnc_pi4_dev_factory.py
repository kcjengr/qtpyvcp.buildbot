...
factory_tnc_pi4_dev = util.BuildFactory()


# download sources
factory_tnc_pi4_dev.addStep(steps.GitHub(name="download sources",
                                             ...
                                             workdir="sources/"))
# get git tag
factory_tnc_pi4_dev.addStep(steps.SetPropertyFromCommand(
    name="get git tag",
...
#                                              workdir="docs/"))
#
# factory_tnc_pi4_dev.addStep(steps.ShellCommand(name="reset gh-pages",
#                                                    command=["git", "symbolic-ref", "HEAD", "refs/heads/gh-pages"],
#                                                    workdir="docs/"))
#
# factory_tnc_pi4_dev.addStep(steps.ShellCommand(name="delete git index",
#                                                    command=["rm", ".git/index"],
#                                                    workdir="docs/"))
#
# factory_tnc_pi4_dev.addStep(steps.ShellCommand(name="clean gh-pages",
#                                                    command=["git", "clean", "-fdx"],
#                                                    workdir="docs/"))
#
# factory_tnc_pi4_dev.addStep(
#     steps.Sphinx(
