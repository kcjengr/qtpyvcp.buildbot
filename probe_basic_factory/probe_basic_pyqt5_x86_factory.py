...
factory_probe_basic_pyqt5_x86 = util.BuildFactory()
...
# get git tag
factory_probe_basic_pyqt5_x86.addStep(steps.SetPropertyFromCommand(
    name="get git tag",
...
factory_probe_basic_pyqt5_x86.addStep(steps.FileUpload(
    ...
    masterdest=util.Interpolate("/home/buildbot/repo/probe_basic-pyqt5-x86/python3-probe-basic_%(prop:tag)s_all.deb"),
    mode=0o644))
...
factory_probe_basic_pyqt5_x86.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/probe_basic-pyqt5-x86/python3-probe-basic_%(prop:tag)s_amd64.deb"),
    masterdest=util.Interpolate("/home/buildbot/debian/apt/pool/main/bookworm/python3-probe-basic_%(prop:tag)s_amd64.deb")))
...
#                                              workdir="docs/"))
#
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="reset gh-pages",
#                                                    command=["git", "symbolic-ref", "HEAD", "refs/heads/gh-pages"],
#                                                    workdir="docs/"))
#
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="delete git index",
#                                                    command=["rm", ".git/index"],
#                                                    workdir="docs/"))
#
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="clean gh-pages",
#                                                    command=["git", "clean", "-fdx"],
#                                                    workdir="docs/"))
#
# factory_probe_basic_pyqt5_x86.addStep(
#     steps.Sphinx(
...
#         workdir="docs/"))
#
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="add doc files", command=["git", "add", "."], workdir="docs/"))
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="commit doc files", command=["git", "commit", "-a", "-m", "deploy gh-pages"], workdir="docs/"))
# factory_probe_basic_pyqt5_x86.addStep(steps.ShellCommand(name="push docs", command=["git", "push", "--force", "origin", "gh-pages"], workdir="docs/"))
