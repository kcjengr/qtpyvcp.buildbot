...
factory_probe_basic_py2.addStep(steps.CopyDirectory(name="copy builds to core package",
                                                    src="sources/dist",
                                                    dest="sources/pb-installer/packages/com.probebasic.core/data/"))

# sim files to installer directories
factory_probe_basic_py2.addStep(steps.CopyDirectory(name="copy configs to sim package",
                                                    src="sources/config",
