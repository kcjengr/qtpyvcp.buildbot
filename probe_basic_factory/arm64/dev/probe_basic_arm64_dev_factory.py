...
factory_probe_basic_am64_dev = util.BuildFactory()


# download sources
factory_probe_basic_am64_dev.addStep(steps.GitHub(name="download sources",
                                             ...
                                             workdir="sources/"))
# git fetch
factory_probe_basic_am64_dev.addStep(steps.ShellCommand(
    name="git fetch",
    command=["/bin/sh", "-c", "git fetch --all"],
    workdir="sources/"))
# get git tag
factory_probe_basic_am64_dev.addStep(steps.SetPropertyFromCommand(
    name="get git tag",
...
factory_probe_basic_am64_dev.addStep(steps.FileUpload(
...
factory_probe_basic_am64_dev.addStep(steps.MasterShellCommand(
