...
factory_probe_basic_dev.addStep(steps.RemoveDirectory(name="delete docs directory", dir="docs_src/"))
...
factory_probe_basic_dev.addStep(steps.ShellCommand(name="Initialize docs repository",
                                               command=["git", "init"],
                                               workdir="docs_src/"))

factory_probe_basic_dev.addStep(steps.ShellCommand(name="add remote repository",
                                               command=["git", "remote", "add", "origin", "git@github.com:kcjengr/probe_basic.git"],
                                               workdir="docs_src/"))

factory_probe_basic_dev.addStep(steps.ShellCommand(name="switch branch",
                                               command=["git", "checkout", "-b", "gh-pages"],
                                               workdir="docs_src/"))

factory_probe_basic_dev.addStep(steps.ShellCommand(name="add docs",
                                               command=["git", "add", "."],
                                               workdir="docs_src/"))

factory_probe_basic_dev.addStep(steps.ShellCommand(name="commit docs",
                                               command=["git", "commit", "-m", "Deploy docs"],
                                               workdir="docs_src/"))

factory_probe_basic_dev.addStep(steps.ShellCommand(name="push docs",
