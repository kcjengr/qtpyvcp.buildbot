...
factory_tnc_pyqt5_arm64_dev.addStep(steps.FileUpload(
    ...
    masterdest=util.Interpolate("/home/buildbot/repo/tnc-pyqt5-arm64-dev/python3-qtpyvcp.tnc_%(prop:tag)s-%(prop:minor_version)s.dev_arm64.deb"),
    mode=0o644))
...
factory_tnc_pyqt5_arm64_dev.addStep(
    steps.ShellCommand(
