...
factory_probe_basic.addStep(steps.ShellCommand(
    ...
    command=["/home/buildbot/buildbot/venvs/buildbot_venv/bin/python", "-m", "pip", "install", "--upgrade", "qtpyvcp"],
...
factory_probe_basic.addStep(steps.ShellCommand(
    ...
    command=["/home/buildbot/buildbot/venvs/probe_basic_venv/bin/python", "-m", "pip", "install", "--upgrade", "qtpyvcp"],
    env={"VIRTUAL_ENV": "/home/buildbot/buildbot/venvs/probe_basic_venv"},
    workdir="sources/"))

# install sources to virtual env
factory_probe_basic.addStep(steps.ShellCommand(
    name="install probe basic from sources into build venv",
    command=["/home/buildbot/buildbot/venvs/probe_basic_venv/bin/python", "-m", "pip", "install", "--upgrade", "."],
    env={"VIRTUAL_ENV": "/home/buildbot/buildbot/venvs/probe_basic_venv"},
    workdir="sources/"))
...
factory_probe_basic.addStep(steps.ShellCommand(
    ...
    command=["/home/buildbot/buildbot/venvs/probe_basic_venv/bin/python", "setup.py", "bdist_wheel"],
    env={"VIRTUAL_ENV": "/home/buildbot/buildbot/venvs/probe_basic_venv"},
    workdir="sources/"))
...
factory_probe_basic.addStep(steps.ShellCommand(
    ...
    command=["/home/buildbot/buildbot/venvs/probe_basic_venv/bin/python", "setup.py", "sdist"],
    env={"VIRTUAL_ENV": "/home/buildbot/buildbot/venvs/probe_basic_venv"},
    workdir="sources/"))
...
factory_probe_basic.addStep(
    steps.SetPropertyFromCommand(
        ...
        command=["/home/buildbot/buildbot/venvs/probe_basic_venv/bin/python",
