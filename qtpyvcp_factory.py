...
factory_qtpyvcp.addStep(steps.ShellCommand(
    command=["/home/kcjengr/buildbot/qtpyvcp_venv/bin/python", "-m", "pip", "install", "."],
    env={"VIRTUAL_ENV": "/home/kcjengr/buildbot/qtpyvcp_venv"}))

# build source and wheel for distribution
factory_qtpyvcp.addStep(steps.ShellCommand(
    command=["/home/kcjengr/buildbot/qtpyvcp_venv/bin/python", "setup.py", "bdist_wheel"],
    env={"VIRTUAL_ENV": "/home/kcjengr/buildbot/qtpyvcp_venv"}))

# get version from installed python package
factory_qtpyvcp.addStep(steps.SetPropertyFromCommand(workdir="build",
                                                     command=["/home/kcjengr/buildbot/qtpyvcp_venv/bin/python",
                                                              "installer/check_version.py"],
                                                     property="qtpyvcp_version",
                                                     env={
                                                         "VIRTUAL_ENV": "/home/kcjengr/buildbot/qtpyvcp_venv"}))
