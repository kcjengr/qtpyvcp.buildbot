...
factory_monokrom_pyqt5_arm64_dev = util.BuildFactory()


# download sources
factory_monokrom_pyqt5_arm64_dev.addStep(steps.GitHub(name="download sources",
...
factory_monokrom_pyqt5_arm64_dev.addStep(steps.MasterShellCommand(
...
factory_monokrom_pyqt5_arm64_dev.addStep(
    steps.ShellCommand(
...
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.GitHub(name="downlaod static docs",
...
#                                              workdir="docs/"))
#
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="reset gh-pages",
#                                                    command=["git", "symbolic-ref", "HEAD", "refs/heads/gh-pages"],
#                                                    workdir="docs/"))
#
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="delete git index",
#                                                    command=["rm", ".git/index"],
#                                                    workdir="docs/"))
#
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="clean gh-pages",
...
#         workdir="docs/"))
#
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="add doc files", command=["git", "add", "."], workdir="docs/"))
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="commit doc files", command=["git", "commit", "-a", "-m", "deploy gh-pages"], workdir="docs/"))
# factory_monokrom_pyqt5_arm64_dev.addStep(steps.ShellCommand(name="push docs", command=["git", "push", "--force", "origin", "gh-pages"], workdir="docs/"))
