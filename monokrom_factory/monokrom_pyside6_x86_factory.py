...
factory_monokrom_pyside6_x86.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/monokrom-pyside6-x86/python3-monokrom_%(prop:tag)s-%(prop:minor_version)s.amd64.deb"),
    masterdest=util.Interpolate("/home/buildbot/repo/monokrom-pyside6-x86-dev/python3-monokrom_%(prop:tag)s-%(prop:minor_version)s.amd64.deb"),
    mode=0o644))
...
factory_monokrom_pyside6_x86.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/monokrom-pyside6-x86/python3-monokrom_%(prop:tag)s-%(prop:minor_version)s.amd64.deb"),
    masterdest=util.Interpolate("/home/buildbot/debian/apt/pool/main/trixie/python3-monokrom_%(prop:tag)s-%(prop:minor_version)s.amd64.deb")))
