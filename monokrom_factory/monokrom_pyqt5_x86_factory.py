...
factory_monokrom_pyqt5_x86.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/monokrom-pyqt5-x86/python3-monokrom_%(prop:tag)s_amd64.deb"),
    masterdest=util.Interpolate("/home/buildbot/repo/monokrom-pyqt5-x86/python3-monokrom_%(prop:tag)s_amd64.deb"),
    mode=0o644))
...
factory_monokrom_pyqt5_x86.addStep(steps.FileUpload(
    ...
    workersrc=util.Interpolate("/home/bb/work/monokrom-pyqt5-x86/python3-monokrom_%(prop:tag)s_amd64.deb"),
    masterdest=util.Interpolate("/home/buildbot/debian/apt/pool/main/bookworm/python3-monokrom_%(prop:tag)s_amd64.deb")))
