...
factory_monokrom_pyqt5_x86_dev.addStep(steps.FileUpload(
    ...
    masterdest=util.Interpolate("/home/buildbot/repo/monokrom-pyqt5-x86-dev/python3-qtpyvcp.monokrom_%(prop:tag)s-%(prop:minor_version)s.dev_amd64dev_amd64.deb"),
    mode=0o644))
