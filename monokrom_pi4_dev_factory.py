...
factory_monokrom_pi4_dev = util.BuildFactory()


# download sources
factory_monokrom_pi4_dev.addStep(steps.GitHub(name="download sources",
...
# factory_monokrom_pi4_dev.addStep(steps.GitHub(name="downlaod static docs",
...
#                                              workdir="docs/"))
#
# factory_monokrom_pi4_dev.addStep(steps.ShellCommand(name="reset gh-pages",
#                                                    command=["git", "symbolic-ref", "HEAD", "refs/heads/gh-pages"],
#                                                    workdir="docs/"))
#
# factory_monokrom_pi4_dev.addStep(steps.ShellCommand(name="delete git index",
#                                                    command=["rm", ".git/index"],
#                                                    workdir="docs/"))
#
# factory_monokrom_pi4_dev.addStep(steps.ShellCommand(name="clean gh-pages",
#                                                    command=["git", "clean", "-fdx"],
#                                                    workdir="docs/"))
#
# factory_monokrom_pi4_dev.addStep(
#     steps.Sphinx(
